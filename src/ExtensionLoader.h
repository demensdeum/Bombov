...
void loadInstanceExtensionsCommands(
    VkInstance instance, const std::vector<const char *> &instanceExtensions);
void unloadInstanceExtensionsCommands(VkInstance instance);

void loadDeviceExtensionsCommands(
    VkDevice device, const std::vector<const char *> &instanceExtensions);
...
void populatePhysicalDeviceInstaceMap(const VkInstance instance) {
  const std::vector<VkPhysicalDevice> physicalDevices =
      enumerate<VkPhysicalDevice>(instance);
  for (const auto pd : physicalDevices)
    physicalDeviceInstanceMap[pd] = instance;
}
...
void loadInstanceExtensionsCommands(
  ...
  for (const auto e : instanceExtensions) {
    if (strcmp(e, VK_KHR_GET_PHYSICAL_DEVICE_PROPERTIES_2_EXTENSION_NAME) == 0)
      loadPDProps2Commands(instance);
    ...
    if (strcmp(e, VK_KHR_EXTERNAL_MEMORY_CAPABILITIES_EXTENSION_NAME) == 0)
      loadExternalMemoryCapsCommands(instance);
    // ...
  }
}
...
void unloadInstanceExtensionsCommands(const VkInstance instance) {
  ...
  for (const auto e : instanceExtensionsMap.at(instance)) {
    if (strcmp(e, VK_KHR_GET_PHYSICAL_DEVICE_PROPERTIES_2_EXTENSION_NAME) == 0)
      unloadPDProps2Commands(instance);
    if (strcmp(e, VK_EXT_DEBUG_REPORT_EXTENSION_NAME) == 0)
      unloadDebugReportCommands(instance);
    if (strcmp(e, VK_EXT_DEBUG_UTILS_EXTENSION_NAME) == 0)
      unloadDebugUtilsCommands(instance);
    if (strcmp(e, VK_KHR_EXTERNAL_MEMORY_CAPABILITIES_EXTENSION_NAME) == 0)
      unloadExternalMemoryCapsCommands(instance);
    // ...
  }
...
void loadDeviceExtensionsCommands(
    const VkDevice device, const std::vector<const char *> &deviceExtensions) {
  using std::strcmp;

  deviceExtensionsMap[device] = deviceExtensions;

  for (const auto e : deviceExtensions) {
    if (strcmp(e, VK_KHR_EXTERNAL_MEMORY_EXTENSION_NAME) == 0)
      loadExternalMemoryCommands(device);
#ifdef VK_USE_PLATFORM_WIN32_KHR
    if (strcmp(e, VK_KHR_EXTERNAL_MEMORY_WIN32_EXTENSION_NAME) == 0)
      loadExternalMemoryWin32Commands(device);
#endif
    if (strcmp(e, VK_KHR_DEDICATED_ALLOCATION_EXTENSION_NAME) == 0)
      loadDedicatedAllocationCommands(device);
    // ...
  }
}
...
void unloadDeviceExtensionsCommands(const VkDevice device) {
  ...
  for (const auto e : deviceExtensionsMap.at(device)) {
    if (strcmp(e, VK_KHR_EXTERNAL_MEMORY_EXTENSION_NAME) == 0)
      unloadExternalMemoryCommands(device);
#ifdef VK_USE_PLATFORM_WIN32_KHR
    if (strcmp(e, VK_KHR_EXTERNAL_MEMORY_WIN32_EXTENSION_NAME) == 0)
      unloadExternalMemoryWin32Commands(device);
#endif
    if (strcmp(e, VK_KHR_DEDICATED_ALLOCATION_EXTENSION_NAME) == 0)
      unloadDedicatedAllocationCommands(device);
    // ...
  }
...
std::unordered_map<VkInstance, PFN_vkGetPhysicalDeviceFeatures2KHR>
    GetPhysicalDeviceFeatures2KHRDispatchTable;
std::unordered_map<VkInstance, PFN_vkGetPhysicalDeviceProperties2KHR>
    GetPhysicalDeviceProperties2KHRDispatchTable;
std::unordered_map<VkInstance, PFN_vkGetPhysicalDeviceFormatProperties2KHR>
    GetPhysicalDeviceFormatProperties2KHRDispatchTable;
std::unordered_map<VkInstance, PFN_vkGetPhysicalDeviceImageFormatProperties2KHR>
    GetPhysicalDeviceImageFormatProperties2KHRDispatchTable;
std::unordered_map<VkInstance, PFN_vkGetPhysicalDeviceQueueFamilyProperties2KHR>
    GetPhysicalDeviceQueueFamilyProperties2KHRDispatchTable;
std::unordered_map<VkInstance, PFN_vkGetPhysicalDeviceMemoryProperties2KHR>
    GetPhysicalDeviceMemoryProperties2KHRDispatchTable;
std::unordered_map<VkInstance,
...
void loadPDProps2Commands(VkInstance instance) {
  ...
  if (!temp_fp)
    throw "Failed to load vkGetPhysicalDeviceFeatures2KHR"; // check shouldn't
                                                            // be necessary
                                                            // (based on spec)
  GetPhysicalDeviceFeatures2KHRDispatchTable[instance] =
      reinterpret_cast<PFN_vkGetPhysicalDeviceFeatures2KHR>(temp_fp);

  temp_fp =
      vkGetInstanceProcAddr(instance, "vkGetPhysicalDeviceProperties2KHR");
  if (!temp_fp)
    throw "Failed to load vkGetPhysicalDeviceProperties2KHR"; // check shouldn't
                                                              // be necessary
                                                              // (based on spec)
  GetPhysicalDeviceProperties2KHRDispatchTable[instance] =
      reinterpret_cast<PFN_vkGetPhysicalDeviceProperties2KHR>(temp_fp);

  temp_fp = vkGetInstanceProcAddr(instance,
                                  "vkGetPhysicalDeviceFormatProperties2KHR");
  if (!temp_fp)
    throw "Failed to load vkGetPhysicalDeviceFormatProperties2KHR"; // check
                                                                    // shouldn't
                                                                    // be
                                                                    // necessary
                                                                    // (based on
                                                                    // spec)
  GetPhysicalDeviceFormatProperties2KHRDispatchTable[instance] =
      reinterpret_cast<PFN_vkGetPhysicalDeviceFormatProperties2KHR>(temp_fp);

  temp_fp = vkGetInstanceProcAddr(
      instance, "vkGetPhysicalDeviceImageFormatProperties2KHR");
  if (!temp_fp)
    throw "Failed to load vkGetPhysicalDeviceImageFormatProperties2KHR"; // check
                                                                         // shouldn't
                                                                         // be
                                                                         // necessary
                                                                         // (based
                                                                         // on
                                                                         // spec)
  GetPhysicalDeviceImageFormatProperties2KHRDispatchTable[instance] =
  ...
  if (!temp_fp)
    throw "Failed to load vkGetPhysicalDeviceQueueFamilyProperties2KHR"; // check
                                                                         // shouldn't
                                                                         // be
                                                                         // necessary
                                                                         // (based
                                                                         // on
                                                                         // spec)
  GetPhysicalDeviceQueueFamilyProperties2KHRDispatchTable[instance] =
  ...
  if (!temp_fp)
    throw "Failed to load vkGetPhysicalDeviceMemoryProperties2KHR"; // check
                                                                    // shouldn't
                                                                    // be
                                                                    // necessary
                                                                    // (based on
                                                                    // spec)
  GetPhysicalDeviceMemoryProperties2KHRDispatchTable[instance] =
      reinterpret_cast<PFN_vkGetPhysicalDeviceMemoryProperties2KHR>(temp_fp);

  temp_fp = vkGetInstanceProcAddr(
      instance, "vkGetPhysicalDeviceSparseImageFormatProperties2KHR");
  if (!temp_fp)
    throw "Failed to load vkGetPhysicalDeviceSparseImageFormatProperties2KHR"; // check shouldn't be necessary (based on spec)
  GetPhysicalDeviceSparseImageFormatProperties2KHRDispatchTable[instance] =
...
VKAPI_ATTR void VKAPI_CALL vkGetPhysicalDeviceProperties2KHR(
  ...
  const VkInstance instance = physicalDeviceInstanceMap.at(physicalDevice);
  auto dispatched_cmd =
      GetPhysicalDeviceProperties2KHRDispatchTable.at(instance);
...
VKAPI_ATTR void VKAPI_CALL vkGetPhysicalDeviceFormatProperties2KHR(
  ...
  const VkInstance instance = physicalDeviceInstanceMap.at(physicalDevice);
  auto dispatched_cmd =
      GetPhysicalDeviceFormatProperties2KHRDispatchTable.at(instance);
...
VKAPI_ATTR VkResult VKAPI_CALL vkGetPhysicalDeviceImageFormatProperties2KHR(
  ...
  const VkInstance instance = physicalDeviceInstanceMap.at(physicalDevice);
  auto dispatched_cmd =
      GetPhysicalDeviceImageFormatProperties2KHRDispatchTable.at(instance);
  return dispatched_cmd(physicalDevice, pImageFormatInfo,
...
VKAPI_ATTR void VKAPI_CALL vkGetPhysicalDeviceQueueFamilyProperties2KHR(
  ...
  const VkInstance instance = physicalDeviceInstanceMap.at(physicalDevice);
  auto dispatched_cmd =
      GetPhysicalDeviceQueueFamilyProperties2KHRDispatchTable.at(instance);
  return dispatched_cmd(physicalDevice, pQueueFamilyPropertyCount,
...
VKAPI_ATTR void VKAPI_CALL vkGetPhysicalDeviceMemoryProperties2KHR(
  ...
  const VkInstance instance = physicalDeviceInstanceMap.at(physicalDevice);
  auto dispatched_cmd =
      GetPhysicalDeviceMemoryProperties2KHRDispatchTable.at(instance);
...
VKAPI_ATTR void VKAPI_CALL vkGetPhysicalDeviceSparseImageFormatProperties2KHR(
  ...
  const VkInstance instance = physicalDeviceInstanceMap.at(physicalDevice);
  auto dispatched_cmd =
      GetPhysicalDeviceSparseImageFormatProperties2KHRDispatchTable.at(
          instance);
  return dispatched_cmd(physicalDevice, pFormatInfo, pPropertyCount,
                        pProperties);
}
...
std::unordered_map<VkInstance, PFN_vkCreateDebugReportCallbackEXT>
    CreateDebugReportCallbackEXTDispatchTable;
std::unordered_map<VkInstance, PFN_vkDestroyDebugReportCallbackEXT>
    DestroyDebugReportCallbackEXTDispatchTable;
std::unordered_map<VkInstance, PFN_vkDebugReportMessageEXT>
    DebugReportMessageEXTDispatchTable;
...
void loadDebugReportCommands(VkInstance instance) {
  ...
  if (!temp_fp)
    throw "Failed to load vkCreateDebugReportCallbackEXT"; // check shouldn't be
                                                           // necessary (based
                                                           // on spec)
  CreateDebugReportCallbackEXTDispatchTable[instance] =
      reinterpret_cast<PFN_vkCreateDebugReportCallbackEXT>(temp_fp);

  temp_fp = vkGetInstanceProcAddr(instance, "vkDestroyDebugReportCallbackEXT");
  if (!temp_fp)
    throw "Failed to load vkDestroyDebugReportCallbackEXT"; // check shouldn't
                                                            // be necessary
                                                            // (based on spec)
  DestroyDebugReportCallbackEXTDispatchTable[instance] =
      reinterpret_cast<PFN_vkDestroyDebugReportCallbackEXT>(temp_fp);

  temp_fp = vkGetInstanceProcAddr(instance, "vkDebugReportMessageEXT");
  if (!temp_fp)
    throw "Failed to load vkDebugReportMessageEXT"; // check shouldn't be
                                                    // necessary (based on spec)
  DebugReportMessageEXTDispatchTable[instance] =
      reinterpret_cast<PFN_vkDebugReportMessageEXT>(temp_fp);
}
...
VKAPI_ATTR VkResult VKAPI_CALL vkCreateDebugReportCallbackEXT(
  ...
  if (CreateDebugReportCallbackEXTDispatchTable.size() < 1) {
    throw std::runtime_error(
        "CreateDebugReportCallbackEXTDispatchTable.size() < 1");
  }
...
VKAPI_ATTR void VKAPI_CALL vkDebugReportMessageEXT(
  ...
  return dispatched_cmd(instance, flags, objectType, object, location,
...
void loadDebugUtilsCommands(VkInstance instance) {
  ...
  if (!temp_fp)
    throw "Failed to load vkCreateDebugUtilsMessengerEXT"; // check shouldn't be
                                                           // necessary (based
                                                           // on spec)
...
void loadExternalMemoryCapsCommands(VkInstance instance) {
  ...
  if (!temp_fp)
    throw "Failed to load vkGetPhysicalDeviceExternalBufferPropertiesKHR"; // check
                                                                           // shouldn't
                                                                           // be
                                                                           // necessary
                                                                           // (based
                                                                           // on
                                                                           // spec)
  GetPhysicalDeviceExternalBufferPropertiesKHRDispatchTable[instance] =
...
VKAPI_ATTR void VKAPI_CALL vkGetPhysicalDeviceExternalBufferPropertiesKHR(
  ...
  const VkInstance instance = physicalDeviceInstanceMap.at(physicalDevice);
  auto dispatched_cmd =
      GetPhysicalDeviceExternalBufferPropertiesKHRDispatchTable.at(instance);
  return dispatched_cmd(physicalDevice, pExternalBufferInfo,
...
std::unordered_map<VkDevice, PFN_vkGetMemoryWin32HandlePropertiesKHR>
    GetMemoryWin32HandlePropertiesKHRDispatchTable;
...
void loadExternalMemoryWin32Commands(VkDevice device) {
  ...
  if (!temp_fp)
    throw "Failed to load vkGetMemoryWin32HandleKHR"; // check shouldn't be
                                                      // necessary (based on
                                                      // spec)
  GetMemoryWin32HandleKHRDispatchTable[device] =
      reinterpret_cast<PFN_vkGetMemoryWin32HandleKHR>(temp_fp);

  temp_fp = vkGetDeviceProcAddr(device, "vkGetMemoryWin32HandlePropertiesKHR");
  if (!temp_fp)
    throw "Failed to load vkGetMemoryWin32HandlePropertiesKHR"; // check
                                                                // shouldn't be
                                                                // necessary
                                                                // (based on
                                                                // spec)
  GetMemoryWin32HandlePropertiesKHRDispatchTable[device] =
      reinterpret_cast<PFN_vkGetMemoryWin32HandlePropertiesKHR>(temp_fp);
}
...
VKAPI_ATTR VkResult VKAPI_CALL vkGetMemoryWin32HandlePropertiesKHR(
  ...
  auto dispatched_cmd =
      GetMemoryWin32HandlePropertiesKHRDispatchTable.at(device);
  return dispatched_cmd(device, handleType, handle,
